...
cap = cv2.VideoCapture('Data/094628_392.mp4')
...
while 1:
    ...
    if ret:
        if previous_frame is None:
            ...
            U, V = optical_flow(previous_frame, img2, 3, 0.05)

            # Save results
            img2 = cv2.cvtColor(img2, cv2.COLOR_GRAY2RGB)
            drawSeperately(previous_frame, img2, U, V, "Grove_Seperate_Result1.png")
            drawOnFrame(img2, U, V, 'Grove_Result1.png')
            break
        count += 1
